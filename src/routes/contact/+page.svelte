...
>
	<div class="w-full max-w-xl overflow-scroll px-3 lg:px-0" id="contactCard">
		...
		>
			...
			<div class="px-5 py-5 text-sm leading-8">
				<p>
					저희 102 컴퍼니에 의뢰해주셔서 감사합니다. <br />의뢰 전에 몇가지
					항목에 답해주시면 더욱 자세하게 상담 도와드릴 수 있습니다.
				</p>
				<ul class="mt-3 text-xs leading-8">
					<li>1.</li>
					<li>2.</li>
					<li>3.</li>
				</ul>
